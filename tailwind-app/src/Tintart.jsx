...
import sudadera from './assets/img/Sudadera.png';
import tote_bag from './assets/img/Tote.png';
...
const categories = [
  { name: "PLAYERAS", image: playera },
  { name: "SUDADERAS", image: sudadera },
  { name: "TOTE BAG", image: tote_bag },
  { name: "OTROS", image: otros },
];
      ...
      <section className="relative bg-[#cbddc5] py-7 px-15 rounded-lg mx-30 my-6 overflow-hidden shadow">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center gap-8 text-center">
            ...
            <div className="flex-1 w-full md:w-auto flex justify-center items-center">
                <img
                    src={logo} // Ajusta la ruta a tu imagen real
  ...
  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
    {categories.map((cat) => (
      ...
      >
        ...
        />
        <span className="text-sm sm:text-base font-medium text-gray-800">{cat.name}</span>
      </a>
    ))}
  </div>
</section>
          ...
          {featuredProducts.map((p) => (
            ...
            >
              ...
              <div className="p-4 text-center">
                <h5 className="text-base md:text-lg font-semibold text-[#4f614f]">{p.name}</h5>
